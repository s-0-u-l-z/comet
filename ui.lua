...
function comet:new(props)
    ...
    local gradientAccent2 = props.gradientAccent2 or Color3.fromRGB(255, 255, 255)
    local borderColor = props.borderColor or Color3.fromRGB(56, 56, 56)
    local sectionSpacing = props.sectionSpacing or 10
    local window = {}
    ...
    addCorner(outline, 10)
    addGradient(outline, color, gradientAccent2, 0)
    ...
    addCorner(outline2, 10)
    addStroke(outline2, borderColor, 1, 0.25)
    ...
    addCorner(indent, 10)
    addGradient(indent, Color3.fromRGB(26, 26, 26), Color3.fromRGB(14, 14, 14), 90)
    addStroke(indent, Color3.fromRGB(28, 28, 28), 1, 0.2)
    ...
    addCorner(main, 8)
    addGradient(main, Color3.fromRGB(22, 22, 22), Color3.fromRGB(16, 16, 16), 90)
    addStroke(main, borderColor, 1, 0.25)
    ...
    addCorner(outline3, 8)
    addGradient(outline3, Color3.fromRGB(26, 26, 26), Color3.fromRGB(18, 18, 18), 90)
    ...
    addCorner(tabs, 6)
    addGradient(tabs, Color3.fromRGB(24, 24, 24), Color3.fromRGB(18, 18, 18), 90)
    addStroke(tabs, borderColor, 1, 0.3)

    local tabsbuttons = utility.new("ScrollingFrame", {
        AnchorPoint = Vector2.new(0.5, 0),
        BackgroundTransparency = 1,
    ...
    addCorner(outline4, 6)
    addGradient(outline4, Color3.fromRGB(22, 22, 22), Color3.fromRGB(16, 16, 16), 90)
...
function comet:watermark()
    ...
    addCorner(outline, 8)
    addGradient(outline, self.theme.accent, self.theme.gradient2, 0)
    ...
    addCorner(outline2, 8)
    addStroke(outline2, self.theme.border, 1, 0.25)
    ...
    con = title:GetPropertyChangedSignal("TextBounds"):Connect(function()
        outline.Size = UDim2.new(0, title.TextBounds.X + 24, 0, 28)
    end)
...
function comet:loader(props)
    ...
    local tempLabel = utility.new("TextLabel", {
        BackgroundTransparency = 1,
    ...
    local function makebutton(name, parent)
        local button_holder = utility.new("Frame", {
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            ZIndex = 9904,
            Parent = parent
        })
        local button_outline = utility.new("Frame", {
            BackgroundColor3 = Color3.fromRGB(24, 24, 24),
            BorderSizePixel = 0,
            Position = UDim2.new(0, 0, 0, 0),
            Size = UDim2.new(1, 0, 1, 0),
        ...
        addCorner(button_outline, 6)
        addStroke(button_outline, self.theme.border, 1, 0.3)
        local button_outline2 = utility.new("Frame", {
            BackgroundColor3 = Color3.fromRGB(24, 24, 24),
            BorderSizePixel = 0,
            Position = UDim2.new(0, 0, 0, 0),
            Size = UDim2.new(1, 0, 1, 0),
        ...
        addCorner(button_outline2, 6)
        local button_color = utility.new("Frame", {
            AnchorPoint = Vector2.new(0, 0),
        ...
        addCorner(button_color, 6)
        addGradient(button_color, Color3.fromRGB(38, 38, 38), Color3.fromRGB(28, 28, 28), 90)
        local button_button = utility.new("TextButton", {
            AnchorPoint = Vector2.new(0, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 1, 0),
            Position = UDim2.new(0, 0, 0, 0),
    ...
    close[3].MouseButton1Down:Connect(function()
        close[2].UIStroke.Color = self.theme.accent
        outline:TweenPosition(UDim2.new(-1.5, 0, 0.5, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.75, true)
        closed()
        wait(0.05)
        close[2].UIStroke.Color = self.theme.border
        wait(0.7)
        screen:Remove()
    end)

    ok[3].MouseButton1Down:Connect(function()
        ok[2].UIStroke.Color = self.theme.accent
        outline:TweenPosition(UDim2.new(1.5, 0, 0.5, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.75, true)
        logedin()
        wait(0.05)
        ok[2].UIStroke.Color = self.theme.border
        wait(0.7)
        screen:Remove()
    end)
...
function comet:settheme(theme, color)
    local window = self
    if window.theme[theme] ~= nil then
...
function comet:page(props)
    ...
    addStroke(tabbutton, self.theme.border, 1, 0.2)
    ...
    addCorner(outline, 6)
    addGradient(outline, Color3.fromRGB(28, 28, 28), Color3.fromRGB(20, 20, 20), 90)
    ...
    local r_line = utility.new("Frame", {
    ...
    local l_line = utility.new("Frame", {
        AnchorPoint = Vector2.new(1, 0),
        BackgroundColor3 = Color3.fromRGB(56, 56, 56),
        BorderSizePixel = 0,
        Size = UDim2.new(0, 1, 0, 1),
    ...
    utility.new("UIListLayout", {
        ...
        Padding = UDim.new(0, self.theme.spacing),
        Parent = left
    })
    ...
    button.MouseButton1Down:Connect(function()
        if page.open == false then
            ...
            page.line.Size = UDim2.new(1, 0, 0, 4)
            page.line.BackgroundColor3 = self.theme.accent
        end
    end)
...
function pages:openpage()
    ...
    if page.open == false then
        ...
        page.outline.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
        page.line.Size = UDim2.new(1, 0, 0, 4)
        page.line.BackgroundColor3 = page.comet.theme.accent
    end
end
...
function pages:section(props)
    ...
    local spacing = props.spacing or self.comet.theme.spacing
    side = side:lower()
    local section = {}
    ...
    addCorner(sectionholder, 8)
    addGradient(sectionholder, Color3.fromRGB(28, 28, 28), Color3.fromRGB(20, 20, 20), 90)
    addStroke(sectionholder, self.comet.theme.border, 1, 0.25)
...
function pages:multisection(props)
    ...
    local buttons = utility.new("Frame", {
        AnchorPoint = Vector2.new(0.5, 0),
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
    ...
    addCorner(tabs, 6)
    addGradient(tabs, Color3.fromRGB(24, 24, 24), Color3.fromRGB(18, 18, 18), 90)
    addStroke(tabs, self.comet.theme.border, 1, 0.25)
    ...
    local tabs_outline = utility.new("Frame", {
        AnchorPoint = Vector2.new(0, 0),
        BackgroundColor3 = Color3.fromRGB(24, 24, 24),
        BorderSizePixel = 0,
        Size = UDim2.new(1, 0, 1, 0),
...
function multisections:section(props)
    ...
    addCorner(tabbutton, 6)
    addStroke(tabbutton, self.comet.theme.border, 1, 0.2)
    ...
    addCorner(outline, 6)
    addGradient(outline, Color3.fromRGB(24, 24, 24), Color3.fromRGB(16, 16, 16), 90)
    ...
    utility.new("UIListLayout", {
        FillDirection = "Vertical",
        Padding = UDim.new(0, self.spacing or self.comet.theme.spacing),
        Parent = content
    })
    ...
    if isFirst then
        ...
        mssection.line.Size = UDim2.new(1, 0, 0, 4)
        mssection.line.BackgroundColor3 = self.comet.theme.accent
    end
    ...
    button.MouseButton1Down:Connect(function()
        if mssection.open == false then
            ...
            mssection.outline.BackgroundColor3 = Color3.fromRGB(24, 24, 24)
            mssection.line.Size = UDim2.new(1, 0, 0, 4)
            mssection.line.BackgroundColor3 = mssection.comet.theme.accent
        end
    end)
...
function sections:toggle(props)
    ...
    addCorner(outline, 4)
    addStroke(outline, self.comet.theme.border, 1, 0.25)
    ...
    addCorner(color, 4)
    addGradient(color, def and self.comet.theme.accent or Color3.fromRGB(26, 26, 26), def and self.comet.theme.gradient2 or Color3.fromRGB(18, 18, 18), 90)
    if def then
        table.insert(self.comet.themeitems["accent"]["BackgroundColor3"], color)
    end
...
function sections:button(props)
    ...
    addCorner(outline, 6)
    local stroke = addStroke(outline, self.comet.theme.border, 1, 0.3)
    ...
    addCorner(color, 6)
    addGradient(color, Color3.fromRGB(38, 38, 38), Color3.fromRGB(26, 26, 26), 90)

    local buttonpress = utility.new("TextButton", {
        AnchorPoint = Vector2.new(0, 0),
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 1, 0),
        Position = UDim2.new(0, 0, 0, 0),
    ...
    buttonpress.MouseButton1Down:Connect(function()
        callback()
        stroke.Color = self.comet.theme.accent
        wait(0.05)
        stroke.Color = self.comet.theme.border
    end)
...
function sections:slider(props)
    ...
    addCorner(outline, 6)
    local stroke = addStroke(outline, self.comet.theme.border, 1, 0.25)
    ...
    addCorner(color, 6)
    addGradient(color, Color3.fromRGB(36, 36, 36), Color3.fromRGB(24, 24, 24), 90)
...
function sections:dropdown(props)
    ...
    local indicator = utility.new("TextLabel", {
        AnchorPoint = Vector2.new(0.5, 0),
        BackgroundTransparency = 1,
        Size = UDim2.new(1, -10, 1, 0),
        Position = UDim2.new(0.5, 0, 0, 0),
    ...
    local optionsholder = utility.new("Frame", {
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
        Size = UDim2.new(1, 0, 0, 22),
    ...
    local optionsbg = utility.new("Frame", {
        BackgroundColor3 = Color3.fromRGB(24, 24, 24),
        BorderSizePixel = 0,
        Size = UDim2.new(1, 0, 1, 0),
        Parent = optionsoutline
    })
    addCorner(optionsbg, 6)
    addStroke(optionsbg, self.comet.theme.border, 1, 0.25)
...
function sections:buttonbox(props)
    ...
    local buttonboxholder = utility.new("Frame", {
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 0, 38),
        ZIndex = 2,
        Parent = self.content
    ...
    local buttonboxbutton = utility.new("TextButton", {
        AnchorPoint = Vector2.new(0, 0),
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 1, 0),
        Position = UDim2.new(0, 0, 0, 0),
    ...
    for i, v in pairs(options) do
        local bboptionbutton = utility.new("TextButton", {
            AnchorPoint = Vector2.new(0, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 18),
            Text = "",
        ...
        local bboptiontitle = utility.new("TextLabel", {
            AnchorPoint = Vector2.new(0.5, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, -10, 1, 0),
            Position = UDim2.new(0.5, 0, 0, 0),
...
function sections:multibox(props)
    ...
    local multiboxholder = utility.new("Frame", {
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 0, 38),
        ZIndex = 2,
        Parent = self.content
...
function sections:textbox(props)
    ...
    local textboxholder = utility.new("Frame", {
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 0, 38),
        ZIndex = 2,
        Parent = self.content
    ...
    local tbox = utility.new("TextBox", {
        AnchorPoint = Vector2.new(0.5, 0),
        BackgroundTransparency = 1,
        Size = UDim2.new(1, -10, 0, 22),
...
function sections:keybind(props)
    ...
    outline.Size = UDim2.new(0, value.TextBounds.X + 24, 1, 0)
...
function keybinds:set(key)
    if key then
        if typeof(key) == "EnumItem" or typeof(key) == "table" then
            ...
            keybind.outline.Size = UDim2.new(0, keybind.value.TextBounds.X + 24, 1, 0)
        end
    end
end
...
function sections:colorpicker(props)
    ...
    local colorpickerholder = utility.new("Frame", {
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 0, 18),
        ZIndex = 2,
        Parent = self.content
    ...
    local cpcolor = utility.new("Frame", {
    ...
    addCorner(cpcolor, 6)
    addGradient(cpcolor, def, Color3.fromRGB(255, 255, 255), 0)
    ...
    local cpholder = utility.new("Frame", {
        AnchorPoint = Vector2.new(0, 0),
        BackgroundColor3 = Color3.fromRGB(24, 24, 24),
        BorderSizePixel = 0,
    ...
    addCorner(cpholder, 8)
    addStroke(cpholder, self.comet.theme.border, 1, 0.25)

    local outline2b = utility.new("Frame", {
        BackgroundColor3 = Color3.fromRGB(24, 24, 24),
        BorderSizePixel = 0,
        Size = UDim2.new(1, 0, 1, 0),
        ZIndex = 5,
    ...
    addCorner(outline2b, 8)

    local colorBar = utility.new("Frame", {
        AnchorPoint = Vector2.new(0.5, 0),
        BackgroundColor3 = self.comet.theme.accent,
        BorderSizePixel = 0,
        Size = UDim2.new(1, -2, 0, 2),
    ...
    addCorner(colorBar, 8)
    table.insert(self.comet.themeitems["accent"]["BackgroundColor3"], colorBar)

    local cptitle = utility.new("TextLabel", {
        AnchorPoint = Vector2.new(0.5, 0),
        BackgroundTransparency = 1,
        Size = UDim2.new(1, -10, 0, 20),
        Position = UDim2.new(0.5, 0, 0, 0),
    ...
    local cpholder2 = utility.new("Frame", {
        AnchorPoint = Vector2.new(0, 0),
        BackgroundColor3 = Color3.fromRGB(24, 24, 24),
        BorderSizePixel = 0,
    ...
    addCorner(cpholder2, 6)
    addStroke(cpholder2, self.comet.theme.border, 1, 0.25)
    ...
    addCorner(outline3, 6)

    local cpimage = utility.new("ImageButton", {
    ...
    local cpcursor = utility.new("ImageLabel", {
        AnchorPoint = Vector2.new(0.5, 0.5),
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
    ...
    local huepicker = utility.new("Frame", {
        AnchorPoint = Vector2.new(1, 0),
        BackgroundColor3 = Color3.fromRGB(24, 24, 24),
        BorderSizePixel = 0,
        Size = UDim2.new(0.05, 0, 0, 150),
        Position = UDim2.new(1, -6, 0, 22),
        ZIndex = 5,
        Parent = outline2b
    })
    addCorner(huepicker, 6)
    addStroke(huepicker, self.comet.theme.border, 1, 0.25)
    ...
    local huebutton = utility.new("TextButton", {
        AnchorPoint = Vector2.new(0, 0),
        BackgroundTransparency = 1,
        Size = UDim2.new(1, 0, 1, 0),
        Position = UDim2.new(0, 0, 0, 0),
    ...
    addStroke(huecursor, Color3.fromRGB(12, 12, 12), 1, 0)

    local huecursor_inline = utility.new("Frame", {
        BackgroundColor3 = Color3.fromHSV(h, 1, 1),
        BorderSizePixel = 0,
        Size = UDim2.new(1, 0, 1, 0),
        Position = UDim2.new(0, 0, 0, 0),
    ...
    addCorner(huecursor_inline, 3)

    local function textbox(parent, size, position)
        local textbox_holder = utility.new("Frame", {
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            Position = position,
            Size = size,
        ...
        local outline5 = utility.new("Frame", {
            BackgroundColor3 = Color3.fromRGB(24, 24, 24),
            BorderSizePixel = 0,
            Position = UDim2.new(0, 0, 0, 0),
            Size = UDim2.new(1, 0, 1, 0),
        ...
        addCorner(outline5, 6)
        local stroke = addStroke(outline5, self.comet.theme.border, 1, 0.25)
        local outline6 = utility.new("Frame", {
            BackgroundColor3 = Color3.fromRGB(24, 24, 24),
            BorderSizePixel = 0,
            Position = UDim2.new(0, 0, 0, 0),
            Size = UDim2.new(1, 0, 1, 0),
        ...
        addCorner(outline6, 6)
        local color2 = utility.new("Frame", {
            AnchorPoint = Vector2.new(0, 0),
            BackgroundColor3 = Color3.fromRGB(30, 30, 30),
            BorderSizePixel = 0,
        ...
        addCorner(color2, 6)
        addGradient(color2, Color3.fromRGB(36, 36, 36), Color3.fromRGB(24, 24, 24), 90)
        local tbox = utility.new("TextBox", {
            AnchorPoint = Vector2.new(0.5, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 1, 0),
        ...
        local tbox_button = utility.new("TextButton", {
            AnchorPoint = Vector2.new(0, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 1, 0),
            Position = UDim2.new(0, 0, 0, 0),
        ...
        return {textbox_holder, tbox, outline5, stroke}
    end

    local red = textbox(outline2b, UDim2.new(0, 62, 0, 22), UDim2.new(0, 6, 0, 175))
    local green = textbox(outline2b, UDim2.new(0, 62, 0, 22), UDim2.new(0, 6, 0, 175))
    green[1].AnchorPoint = Vector2.new(0.5, 0)
    green[1].Position = UDim2.new(0.5, 0, 0, 175)
    local blue = textbox(outline2b, UDim2.new(0, 62, 0, 22), UDim2.new(0, 6, 0, 175))
    blue[1].AnchorPoint = Vector2.new(1, 0)
    blue[1].Position = UDim2.new(1, -6, 0, 175)
    local hex = textbox(outline2b, UDim2.new(1, -12, 0, 22), UDim2.new(0, 6, 0, 202))
    ...
    red[2].Focused:Connect(function()
        red[4].Color = self.comet.theme.accent
    end)
    red[2].FocusLost:Connect(function()
        ...
        if num then
            ...
            if saved then
                ...
                red[4].Color = self.comet.theme.border
            else
                red[4].Color = self.comet.theme.border
            end
        else
    ...
    green[2].Focused:Connect(function()
        green[4].Color = self.comet.theme.accent
    end)
    green[2].FocusLost:Connect(function()
        ...
        if num then
            ...
            if saved then
                ...
                green[4].Color = self.comet.theme.border
            else
                green[4].Color = self.comet.theme.border
            end
        else
    ...
    blue[2].Focused:Connect(function()
        blue[4].Color = self.comet.theme.accent
    end)
    blue[2].FocusLost:Connect(function()
        ...
        if num then
            ...
            if saved then
                ...
                blue[4].Color = self.comet.theme.border
            else
                blue[4].Color = self.comet.theme.border
            end
        else
    ...
    hex[2].Focused:Connect(function()
        hex[4].Color = self.comet.theme.accent
    end)
        ...
        if #saved >= 6 and #saved <= 7 then
            ...
            if e == true then
                ...
                if hexcolor then
                    ...
                    hex[2].Text = ""
                    hex[4].Color = self.comet.theme.border
                else
                    hex[2].Text = ""
                    hex[4].Color = self.comet.theme.border
                end
...
function sections:selection(props)
    ...
    if not self.content:FindFirstChildOfClass("UIListLayout") then
        utility.new("UIListLayout", {
            FillDirection = "Vertical",
            Padding = UDim.new(0, self.comet.theme.spacing),
            Parent = self.content
        })
    end
    ...
    addCorner(itemsHolder, 6)
    addStroke(itemsHolder, self.comet.theme.border, 1, 0.25)
    ...
    local buttonArea = utility.new("Frame", {
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
    ...
    local scrollFrame = utility.new("ScrollingFrame", {
        BackgroundTransparency = 1,
        BorderSizePixel = 0,
        Size = UDim2.new(1, -12, 1, -buttonAreaHeight - 10),
    ...
    updateButtonArea = function()
        ...
        buttonArea.Size = UDim2.new(1, -12, 0, buttonAreaHeight)
        scrollFrame.Size = UDim2.new(1, -12, 1, -buttonAreaHeight - 12)
    end

    local function createItemUI(name, metadata)
        local itemButton = utility.new("TextButton", {
            AnchorPoint = Vector2.new(0, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 18),
            Position = UDim2.new(0, 0, 0, 0),
        ...
        local itemTitle = utility.new("TextLabel", {
            AnchorPoint = Vector2.new(0.5, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, -10, 1, 0),
            Position = UDim2.new(0.5, 0, 0, 0),
    ...
    local function createButton(props)
        ...
        local btnHolder = utility.new("Frame", {
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
        ...
        local btnOutline = utility.new("Frame", {
            BackgroundColor3 = Color3.fromRGB(24, 24, 24),
            BorderSizePixel = 0,
            Position = UDim2.new(0.5, 0, 0, 0),
            AnchorPoint = Vector2.new(0.5, 0),
        ...
        addCorner(btnOutline, 6)
        local stroke = addStroke(btnOutline, self.comet.theme.border, 1, 0.25)

        local btnOutline2 = utility.new("Frame", {
            BackgroundColor3 = Color3.fromRGB(24, 24, 24),
            BorderSizePixel = 0,
            Position = UDim2.new(0, 0, 0, 0),
            Size = UDim2.new(1, 0, 1, 0),
        ...
        addCorner(btnOutline2, 6)

        local btnColor = utility.new("Frame", {
            AnchorPoint = Vector2.new(0, 0),
            BackgroundColor3 = Color3.fromRGB(30, 30, 30),
            BorderSizePixel = 0,
            Size = UDim2.new(1, 0, 1, 0),
        ...
        addCorner(btnColor, 6)
        addGradient(btnColor, Color3.fromRGB(38, 38, 38), Color3.fromRGB(26, 26, 26), 90)

        local btnButton = utility.new("TextButton", {
            AnchorPoint = Vector2.new(0, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 1, 0),
            Position = UDim2.new(0, 0, 0, 0),
    ...
    function selection:addTextbox(props)
        ...
        local tboxHolder = utility.new("Frame", {
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
            Size = UDim2.new(1, -12, 0, 22),
            ZIndex = 5,
        ...
        local tboxButton = utility.new("TextButton", {
            AnchorPoint = Vector2.new(0, 0),
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 1, 0),
            Position = UDim2.new(0, 0, 0, 0),
...
function comet:notify(props)
    ...
    addCorner(notifHolder, 8)
    addGradient(notifHolder, self.theme.accent, self.theme.gradient2, 0)
    ...
    local contentLabel = utility.new("TextLabel", {
        AnchorPoint = Vector2.new(0.5, 0),
        BackgroundTransparency = 1,
        Size = UDim2.new(1, -10, 1, -32),
        Position = UDim2.new(0.5, 0, 0, 26),
    ...
    local function updatePositions()
        ...
        for i = #activeNotifications, 1, -1 do
            ...
            if notif and notif.holder and notif.holder.Parent then
                notif.holder:TweenPosition(UDim2.new(1, -10, 1, yOffset), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.3, true)
    ...
    notifHolder:TweenPosition(UDim2.new(1, -10, 1, -10), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.5, true)
    task.wait(0.1)
    updatePositions()
    ...
    task.delay(duration, function()
        if not notification.removing then
            ...
            notifHolder:TweenPosition(UDim2.new(1, 350, notifHolder.Position.Y.Scale, notifHolder.Position.Y.Offset), Enum.EasingDirection.In, Enum.EasingStyle.Quad, 0.5, true)
            task.wait(0.5)
...
function sections:paragraph(props)
    ...
    local totalHeight = contentHeight + 7
    if title then
        totalHeight = totalHeight + titlesize + 7
    end

    local paraholder = utility.new("Frame", {
        BackgroundTransparency = 1,
    ...
    if title then
        titlelabel = utility.new("TextLabel", {
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, titlesize + 5),
            Position = UDim2.new(0, 0, 0, 0),
            Font = self.comet.font,
            Text = title,
            TextColor3 = self.comet.theme.accent,
    ...
    function paragraph:settext(newtext)
        ...
        local tempLabel2 = utility.new("TextLabel", {
            BackgroundTransparency = 1,
            Size = UDim2.new(1, 0, 0, 1000),
            Font = self.comet.font,
            Text = newtext,
        ...
        local newTotalHeight = newHeight + yOffset + 7
