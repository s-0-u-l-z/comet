...
function comet:new(props)
	...
	local rounded = props.rounded or props.Rounded or false
	local roundness = props.roundness or props.Roundness or 1
	local window = {}
	...
	applyCorner(outline, rounded, roundness)
	...
	applyCorner(outline2, rounded, roundness)
	...
	applyCorner(indent, rounded, roundness)
	...
	applyCorner(main, rounded, roundness)
	...
	applyCorner(outline3, rounded, roundness)
	...
	applyCorner(holder, rounded, roundness)
	local holder = utility.new(
		"Frame",
		{
			AnchorPoint = Vector2.new(0.5,0.5),
	...
	applyCorner(tabs, rounded, roundness)
	...
	applyCorner(outline4, rounded, roundness)
	utility.new(
		"UIListLayout",
		{
...
function comet:watermark()
	...
	applyCorner(outline, self.rounded, self.roundness)
	...
	applyCorner(outline2, self.rounded, self.roundness)
	local indent = utility.new(
		"Frame",
		{
			AnchorPoint = Vector2.new(0.5,0.5),
	...
	applyCorner(indent, self.rounded, self.roundness)
	local title = utility.new(
		"TextLabel",
		{
			AnchorPoint = Vector2.new(0.5,0),
...
function comet:loader(props)
	...
	local rounded = props.rounded or props.Rounded or self.rounded
	local roundness = props.roundness or props.Roundness or self.roundness
	local loader = {}
	local screen = utility.new(
		"ScreenGui",
		{
	...
	local function makebutton(name, parent)
		...
		applyCorner(button_holder, rounded, roundness)
		...
		applyCorner(button_outline, rounded, roundness)
		...
		applyCorner(button_outline2, rounded, roundness)
...
function comet:page(props)
	...
	applyCorner(tabbutton, self.rounded, self.roundness)
	local outline = utility.new(
		"Frame",
		{
			BackgroundColor3 = Color3.fromRGB(24, 24, 24),
	...
	applyCorner(pageholder, self.rounded, self.roundness)
...
function pages:section(props)
	...
	applyCorner(sectionholder, self.comet.rounded, self.comet.roundness)
	local outline = utility.new(
		"Frame",
		{
			BackgroundColor3 = Color3.fromRGB(24, 24, 24),
	...
	applyCorner(outline, self.comet.rounded, self.comet.roundness)
...
function pages:multisection(props)
	...
	applyCorner(tabs, self.comet.rounded, self.comet.roundness)
	utility.new(
		"UIListLayout",
		{
			FillDirection = "Horizontal",
	...
	applyCorner(tabs_outline, self.comet.rounded, self.comet.roundness)
	multisection = {
		["comet"] = self.comet,
		["sectionholder"] = sectionholder,
		["color"] = color,
...
function multisections:section(props)
	...
	applyCorner(tabbutton, self.comet.rounded, self.comet.roundness)
	local outline = utility.new(
		"Frame",
		{
			BackgroundColor3 = Color3.fromRGB(20, 20, 20),
...
function sections:toggle(props)
	...
	applyCorner(color, self.comet.rounded, self.comet.roundness)
	if def then
		table.insert(self.comet.themeitems["accent"]["BackgroundColor3"],color)
	end
	utility.new(
...
function sections:button(props)
	...
	applyCorner(outline2, self.comet.rounded, self.comet.roundness)
	local color = utility.new(
		"Frame",
		{
			BackgroundColor3 = Color3.fromRGB(30, 30, 30),
...
function sections:colorpicker(props)
	...
	applyCorner(cpholder, self.comet.rounded, self.comet.roundness)
	local outline2 = utility.new(
		"Frame",
		{
			BackgroundColor3 = Color3.fromRGB(24, 24, 24),
	...
	local function textbox(parent,size,position)
		...
		applyCorner(outline5, self.comet.rounded, self.comet.roundness)
...
function sections:selection(props)
	...
	applyCorner(itemsHolder, self.comet.rounded, self.comet.roundness)
	local outline3 = utility.new(
		"Frame",
		{
			BackgroundColor3 = Color3.fromRGB(24, 24, 24),
	...
	local function createButton(propsb)
		...
		applyCorner(btnOutline, self.comet.rounded, self.comet.roundness)
...
function comet:notify(props)
    ...
    applyCorner(notifHolder, self.rounded, self.roundness)
    local outline2 = utility.new(
        "Frame",
        {
            AnchorPoint = Vector2.new(0.5, 0.5),
